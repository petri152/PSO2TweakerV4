...
Partial Class frmDownloader
    ...
    End Sub
    Friend WithEvents ProgressBarX6 As ProgressBar
    Friend WithEvents ProgressBarX5 As ProgressBar
    Friend WithEvents ProgressBarX4 As ProgressBar
    Friend WithEvents ProgressBarX3 As ProgressBar
    Friend WithEvents ProgressBarX2 As ProgressBar
    ...
    Friend WithEvents LabelX3 As Label
    Friend WithEvents LabelX4 As Label
    Friend WithEvents LabelX5 As Label
    Friend WithEvents LabelX6 As Label
End Class
